...
import shutil
shutil.copy("app/routes/auth.py", "app/routes/auth_backup.py")
with open("app/routes/auth.py", "w", encoding="utf-8") as f:
    f.write(NOVO_CONTEUDO)
print("OK! app/routes/auth.py atualizado com checagem de creditos.")
print("Backup salvo em app/routes/auth_backup.py")
